...
public class TaskConfig {
	...
	public String toString() {
		return "TaskConfig [name=" + name + ", group=" + group + ", scheduleType=" + scheduleType
				+ ", scheduleTypeSimpleOptions=" + scheduleTypeSimpleOptions + ", scheduleTypeCalendarIntervalOptions="
				+ scheduleTypeCalendarIntervalOptions + ", scheduleTypeDailyTimeIntervalOptions="
				+ scheduleTypeDailyTimeIntervalOptions + ", scheduleTypeCronOptions=" + scheduleTypeCronOptions
				+ ", startAtType=" + startAtType + ", startAt=" + startAt + ", endAtType=" + endAtType + ", endAt="
				+ endAt + ", taskModule=" + taskModule + ", params=" + params + ", description=" + description
