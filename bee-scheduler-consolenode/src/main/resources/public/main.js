...
require(['vue', 'vue_router', 'vue_resource', 'ELEMENT', 'moment', 'comp/helper-dialog', 'comp/task-detail-dialog'], function (Vue, VueRouter, VueResource, Elem, moment, helperDialog, taskDetailDialog) {
    ...
    var views = {
        ...
        spiderList: function (resolver) {
            require(['comp/spider-list'], resolver);
        },
        spiderEdit: function (resolver) {
            require(['comp/spider-edit'], resolver);
        },
        ...
        routes: [
            {path: '/login', component: views.login},
            {
                ...
                children: [
                    ...
                    {path: '/spider/list', component: views.spiderList},
                    {path: '/spider/new', component: views.spiderEdit, meta: {editFor: "New"}},
                    {path: '/spider/edit', component: views.spiderEdit, meta: {editFor: "Edit"}},
                    {path: '/spider/copy', component: views.spiderEdit, meta: {editFor: "Copy"}},
